...
public class ChatConnection implements Serializable{
    ...
    private class ChatServer implements Serializable{
        ...
        //overloaded because, apparently, handler is not used
        public ChatServer() {
            mThread = new Thread(new ServerThread());
            mThread.start();
        }
        ...
        class ServerThread implements Runnable,Serializable {
            ...
            public void run() {
                ...
                try {
                    ...
                    mServerSocket = new ServerSocket(0);// Initialize a server socket on the next available port by setting it to 0
                    setLocalPort(mServerSocket.getLocalPort());
                    Log.d(TAG, "port is: "+getLocalPort());
